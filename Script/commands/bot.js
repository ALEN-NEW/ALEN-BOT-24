...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "Ummmmah") || (event.body.toLowerCase() == "Ummmah")) {
  ...
  if ((event.body.toLowerCase() == "jisan") || (event.body.toLowerCase() == "jisan🤬") || (event.body.toLowerCase() == "@𝐀𝐋𝐄𝐍 :) 3:) ‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎ㅤ") || (event.body.toLowerCase() == "জিসান")) {
...
9.𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 𝗟𝗜𝗡𝗞 : https://www.facebook.com/ALEN.OKH", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke")) {
     return api.sendMessage("হাই আমি মেছেন্জার ROBOT  আামার বস ALEN🙂😈 আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "baler admin")) {
     return api.sendMessage("তাকে সবাই ALEN🙂😈 নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami jisan") || (event.body.toLowerCase() == "cup sala ami jesan") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Gulu Mulu Dulヽ・　TT") || (event.body.toLowerCase() == "@JERIN一一ꪜ ヽ﹅ ヽ・　o.O")) {
     return api.sendMessage("খবরদার কেউ এই আইডি মেনশন দিবানা এটা আমার বস ALEN🙂😈 এর Best Friend এর আইডি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Aru") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস ALEN🙂😈 এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "jerin") || (event.body.toLowerCase() == "mim")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস ALEN🙂😈 এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Sadia") || (event.body.toLowerCase() == "farhana")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস ALEN🙂😈 এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Noyon") || (event.body.toLowerCase() == "নয়ন")) {
     return api.sendMessage("🥰-noyon-🌺 আমার বস ALEN🙂😈 এর বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে ALEN🙂😈 এর ইনবক্সে চলে যা পাগল ছাগল🌚🐸🌶️🍆", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "dhon") || (event.body.toLowerCase() == "Dhon")) {
     return api.sendMessage("প্যান্ট খুলে দেখা দেখি তোর ধোন কত ইঞ্চি 😦", threadID);
   };
  mess = "{name}"
