...
try {
 ...
 const canvas = Canvas.createCanvas(500, 670);
	...
	fs.writeFileSync(path_toilet,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_toilet, {'highWaterMark': 128 * 1024}), body: "ধর সালারে , সালায় মুরগির দুধ চুরি করতে গিয়া ধরা খাইছে🤣🐸"}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
